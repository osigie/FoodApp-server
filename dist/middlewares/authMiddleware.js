...
var protectRoutes = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = req;
                return [4 /*yield*/, admin_1.default.findById(decoded.id).select("-password")];
            case 2:
                //Get user from the token
                _a.user = _b.sent();
                next();
