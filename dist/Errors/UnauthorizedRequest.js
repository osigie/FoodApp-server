...
var UnauthorizedRequest = /** @class */ (function (_super) {
    __extends(UnauthorizedRequest, _super);
    function UnauthorizedRequest(message, status) {
        if (status === void 0) { status = http_status_codes_1.StatusCodes.UNAUTHORIZED; }
